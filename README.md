...
### 👨‍💻 About Me
- 🎓 **Education:** Informatics Student at **Universitas Sebelas April (UNSAP)**, Sumedang.
- 🛠️ **Current Focus:** Crafting high-performance web applications & modern landing pages.
- 🎯 **Tech Stack:** PHP (Laravel), Tailwind CSS, MySQL, and Vanilla JavaScript.
- 📬 **Get in Touch:** [iqbaal.fd@gmail.com](mailto:iqbaal.fd@gmail.com) | Instagram: [@iqbaalfdllh](https://instagram.com/iqbaalfdllh)
...
| :--- | :--- | :--- | :--- |
| **🚀 KREATIFIN** | Collaborative platform for creative industry ecosystems. | `Laravel 12` `Tailwind` `MySQL` | [Live Demo](https://www.kreatif-in.my.id/) |
| **🖨️ Madani Printing** | High-performance landing page & SEO-optimized for digital printing. | `HTML5` `Tailwind` `JS` `Vercel` | [Live Demo](https://madani-printing.vercel.app/) |
